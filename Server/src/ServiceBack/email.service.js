    ...
    sendMail = async (data) => {
        try {
            this.transporter.sendMail({
                from: '"ShopHub" <karkimanish188@gmail.com>',
                to: data.email,
                ...
                html: `
                    <div style="font-family: Arial, sans-serif; line-height: 1.6; background-color: #f9fafb; padding: 20px;">
                        <div style="max-width: 600px; margin: auto; background: white; border-radius: 10px; padding: 30px; box-shadow: 0 2px 6px rgba(0,0,0,0.1);">
                            ...
                            <a href="${appConfig.activation_link}" 
                            ...
                            <p style="color: #2b6cb0; word-break: break-all;">${appConfig.activation_link}</p>
                            ...
                            <p style="font-size: 14px; color: #999;">
                                Best regards,<br>
                                The <strong>[Your App Name]</strong> Team
                            </p>
                        </div>
                    </div>
                `
                ...
                html: `
                        <div style="font-family: Arial, sans-serif; background-color: #f4f4f4; padding: 20px;">
                            ...
                            <div style="padding: 30px; color: #333;">
                                ...
                                <p style="word-wrap: break-word; color: #007bff;">${data.resetLink}</p>
