      ...
      <div className="w-full max-w-4xl shadow-2xl rounded-3xl bg-white/80 backdrop-blur-md p-8">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Your ultimate e-commerce destination. Discover amazing products, great deals, and a seamless shopping experience.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-2xl mx-auto">
          <Card className="hover:shadow-2xl transition-shadow border-2 border-blue-100 hover:border-blue-300 bg-white/90">
            <CardHeader className="text-center">
              ...
              <CardDescription>Access your existing account to continue shopping</CardDescription>
            </CardHeader>
            <CardContent>
              <Link href="/login">
                <Button className="w-full font-semibold text-lg" variant="default" size="lg">
          ...
          <Card className="hover:shadow-2xl transition-shadow border-2 border-green-100 hover:border-green-300 bg-white/90">
            <CardHeader className="text-center">
              ...
              <CardDescription>Join our community and start your shopping journey</CardDescription>
            </CardHeader>
            <CardContent>
              <Link href="/register">
                <Button className="w-full font-semibold text-lg" variant="outline" size="lg">
                  Create New Account
                </Button>
              </Link>
            </CardContent>
